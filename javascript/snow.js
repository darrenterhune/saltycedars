...
var snowStorm = (function (g, f) {
  ...
  this.resizeHandler = function () {
    g.innerWidth || g.innerHeight
      ...
      : ((h =
          (f.documentElement.clientWidth || f.body.clientWidth || f.body.scrollWidth) -
          (!m ? 8 : 0) -
          a.flakeRightOffset),
  ...
  this.SnowFlake = function (c, d, e) {
    ...
    this.move = function () {
      ...
      b.x >= h || h - b.x < a.flakeWidth
        ? (b.x = 0)
        : 0 > c && b.x - a.flakeLeftOffset < -a.flakeWidth && (b.x = h - a.flakeWidth - 1);
      b.refresh();
  ...
  this.start = function (c) {
    ...
    if (
      ...
      ((c = a.targetElement), (a.targetElement = f.getElementById(c)), !a.targetElement)
    )
